CREATE DATABASE IF NOT EXISTS CompuHouse;
...
precio_por_unidad INT NOT NULL,
subtotal FLOAT NOT NULL
...
CREATE TRIGGER `nuevos_clientes_tr`
	...
	BEGIN
	INSERT INTO `CompuHouse`.`clientes_nuevos_tr` (id_cliente,nombre_cliente,apellido_cliente,telefono_cliente,direccion_cliente,email_cliente,usuario,fecha_hora,db,version)
...
CREATE TRIGGER `cliente_actualizado` 
    ...
    BEGIN
    INSERT INTO `CompuHouse`.`actualizacion_de_clientes_tr` (id_cliente,nombre_cliente,apellido_cliente,telefono_cliente,direccion_cliente,email_cliente,usuario,fecha_hora,db,version)
...
CREATE TRIGGER `productos_nuevos_tr` 
	...
	INSERT INTO `CompuHouse`.`productos_nuevos_tr` (id_producto,nombre_producto,precio_producto,usuario,fecha_hora,db,version)
...
CREATE TRIGGER `productos_actualizados` 
	...
	INSERT INTO `CompuHouse`.`actualizacion_de_productos_tr` (id_producto,nombre_producto,precio_producto,usuario,fecha_hora,db,version)
